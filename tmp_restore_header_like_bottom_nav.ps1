...
$bottomNavContent = @'
<?php // English description: App bottom navigation that reuses the website header actions in the mobile WebView shell. ?>
<?php
$app_shell = !empty($wo['app_shell']) ? $wo['app_shell'] : array();
$app_nav = !empty($app_shell['nav']) ? $app_shell['nav'] : array();
$app_search_label = !empty($app_shell['search_label']) ? $app_shell['search_label'] : (!empty($wo['lang']['search']) ? $wo['lang']['search'] : 'Search');
$app_create_label = !empty($wo['lang']['create']) ? $wo['lang']['create'] : 'Create';
$app_header_background = !empty($wo['config']['header_background']) ? $wo['config']['header_background'] : '#0f3dff';
?>
<style>
body.app-view .content-container {
  padding-bottom: calc(76px + env(safe-area-inset-bottom, 0px)) !important;
}

body.app-view .app-shell-bottom-nav {
  position: fixed;
  left: 0;
  right: 0;
  bottom: 0;
  ...
  background: <?php echo $app_header_background; ?>;
  border-top: 0;
  box-shadow: 0 -12px 28px rgba(15, 23, 42, 0.24);
}

body.app-view .app-shell-bottom-nav__left,
body.app-view .app-shell-bottom-nav #head_menu_rght {
  margin: 0;
  padding: 0;
  list-style: none;
  display: flex;
...
body.app-view .app-shell-bottom-nav__left > li,
body.app-view .app-shell-bottom-nav #head_menu_rght > li:not(.wow_new_search_bbtn):not(.dropdown-switch-account) {
  position: relative;
  flex: 1 1 0;
  min-width: 0;
...
body.app-view .app-shell-bottom-nav .wow_new_search_bbtn {
  display: none !important;
}

body.app-view .app-shell-bottom-nav .dropdown-switch-account {
  display: none;
}

body.app-view .app-shell-bottom-nav .dropdown-switch-account.open {
...
body.app-view .app-shell-bottom-nav .app-shell-bottom-nav__left > li > a,
body.app-view .app-shell-bottom-nav .app-shell-bottom-nav__link,
body.app-view .app-shell-bottom-nav #head_menu_rght > li > a {
  display: flex;
  align-items: center;
...
body.app-view .app-shell-bottom-nav .app-shell-bottom-nav__left > li > a.is-active,
body.app-view .app-shell-bottom-nav #head_menu_rght > li > a.is-active {
  background: rgba(255, 255, 255, 0.14) !important;
}

body.app-view .app-shell-bottom-nav .app-shell-bottom-nav__left > li > a span,
body.app-view .app-shell-bottom-nav .app-shell-bottom-nav__label,
body.app-view .app-shell-bottom-nav #head_menu_rght > li > a span:not(.new-update-alert) {
  display: none !important;
}

body.app-view .app-shell-bottom-nav .app-shell-bottom-nav__left > li > a svg,
body.app-view .app-shell-bottom-nav #head_menu_rght > li > a svg {
  width: 24px;
  height: 24px;
  max-width: 24px;
  max-height: 24px;
...
body.app-view .app-shell-bottom-nav .hide_fill_svg {
  display: none !important;
}

body.app-view .app-shell-bottom-nav .user-avatar {
  width: 28px;
  height: 28px;
  min-width: 28px;
  border-radius: 999px;
...
body.app-view .app-shell-bottom-nav .user-avatar img {
  width: 100%;
  height: 100%;
  object-fit: cover;
}

body.app-view .app-shell-bottom-nav .new-update-alert {
  position: absolute;
  top: 6px;
  right: 8px;
  z-index: 4;
...
body.app-view .app-shell-bottom-nav .dropdown-menu {
  top: auto !important;
...
body.app-view .app-shell-bottom-nav .head_name_links .dropdown-menu {
  left: 0 !important;
  right: auto !important;
  transform: none !important;
}

body.app-view .app-shell-bottom-nav .request-list,
body.app-view .app-shell-bottom-nav .notifications-dropdown {
  left: 50% !important;
  right: auto !important;
  transform: translateX(-50%) !important;
}

body.app-view .app-shell-bottom-nav .ani-acc-menu {
  left: auto !important;
  right: 0 !important;
  transform: none !important;
}

body.app-view .app-shell-bottom-nav .create_head_menu > li {
  float: left;
  width: 50%;
}

body.app-view .app-shell-bottom-nav .ani-acc-menu a,
body.app-view .app-shell-bottom-nav .notifications-dropdown a,
body.app-view .app-shell-bottom-nav .request-list a {
  color: #0f172a !important;
}

body.app-view .app-shell-bottom-nav .ani-acc-menu .user-avatar {
  width: auto;
  height: auto;
  min-width: 0;
  border: 0;
...
body.app-view .app-shell-bottom-nav .dropdown-switch-account .dropdown-menu {
...
<nav class="app-shell-bottom-nav" aria-label="App navigation">
  <ul class="nav navbar-nav app-shell-bottom-nav__left">
    <li>
      <a class="sixteen-font-size app-shell-bottom-nav__link<?php echo !empty($app_nav['home']) ? ' is-active' : ''; ?>" data-app-nav="home" href="<?php echo $wo['config']['site_url']; ?>" data-ajax="?index.php?link1=home" aria-label="<?php echo $wo['lang']['home']; ?>">
    ...
    <li class="dropdown head_name_links">
      <a href="javascript:void(0);" class="dropdown-toggle sixteen-font-size app-shell-bottom-nav__link<?php echo !empty($app_nav['create']) ? ' is-active' : ''; ?>" data-app-nav="create" data-toggle="dropdown" role="button" aria-expanded="false" aria-label="<?php echo $app_create_label; ?>">
...
$paths = @(
  'D:\Duong\src\laragon\www\vnseea_app\website\themes\wowonder\layout\app\bottom-nav.phtml',
  'D:\Duong\src\laragon\www\vnseea_app\website\themes\sunshine\layout\app\bottom-nav.phtml'
)

foreach ($path in $paths) {
  Write-Utf8NoBom $path $bottomNavContent
}
