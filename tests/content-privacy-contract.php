...
$contracts = array(
    ...
    array('api/v2/endpoints/live.php', 'VNSEEA_CreateLiveSession', 'API live creation must use the canonical privacy-aware helper'),
    array('xhr/live.php', 'VNSEEA_CreateLiveSession', 'web live creation must use the canonical privacy-aware helper'),
    array('assets/includes/vnseea_live.php', "['postType'] = 'live'", 'live helper must identify its context before privacy normalization'),
    array('assets/includes/vnseea_live.php', 'VNSEEA_NormalizePostPrivacyRequest', 'live helper must normalize privacy and reject anonymity'),
