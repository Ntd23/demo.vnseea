...
if (empty($current_user_id)) {
    ...
    $response_data = array(
        ...
        'user_data' => array(
            ...
            'lat' => isset($current_user['lat']) ? (string) $current_user['lat'] : '',
            'lng' => isset($current_user['lng']) ? (string) $current_user['lng'] : '',
            'place_id' => !empty($current_user['place_id']) ? $current_user['place_id'] : '',
