<!-- Description: Thin Nuxt route wrapper for the backend-backed account settings screen. -->
<template>
  <SettingsPresentationSettingsPage />
</template>
...
const canonicalUrl = computed(() => new URL(appRoutes.settings, requestURL.origin).toString())
