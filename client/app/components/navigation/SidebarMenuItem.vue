<template>
  <NuxtLink
    ...
    :class="isActive ? 'bg-primary-50 text-primary-600 ring-1 ring-primary-100 shadow-sm shadow-primary-500/5' : 'text-secondary-500 hover:bg-secondary-50 hover:text-primary-600'"
  >
    <span
      class="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border transition-all duration-300"
      :class="isActive ? 'border-primary-200 bg-white text-primary-600 shadow-sm' : 'border-secondary-100 bg-white text-secondary-400 group-hover:border-primary-200 group-hover:text-primary-600'"
    >
