<template>
  <section class="relative z-10 overflow-hidden rounded-[30px] border border-white/70 bg-white/95 p-5 shadow-[var(--shadow-xl)] backdrop-blur sm:p-6">
    ...
    <div class="mt-6 border-t border-[var(--border-default)] pt-6">
      ...
      <div class="mt-6 flex flex-col gap-3 rounded-[24px] border border-[var(--border-default)] bg-white px-4 py-3 lg:flex-row lg:items-center lg:justify-between">
        <div class="min-w-0">
          <p class="text-[11px] font-black uppercase tracking-[0.14em] text-[var(--text-tertiary)]">
