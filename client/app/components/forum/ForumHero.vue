<template>
  <UCard
    class="overflow-hidden rounded-[30px] border border-[var(--border-default)] bg-[linear-gradient(135deg,#0f172a_0%,#1447e6_58%,#0f766e_132%)] text-white shadow-[var(--shadow-xl)]"
