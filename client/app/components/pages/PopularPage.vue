      ...
      <section class="min-w-0 space-y-8">
        ...
        <div class="scrollbar-hide -mx-6 flex gap-4 overflow-x-auto px-6 pb-4 sm:mx-0 sm:px-0 sm:pb-2">
          ...
          >
            ...
            <h3 class="mt-6 text-xl font-black text-[var(--text-primary)] group-hover:text-secondary-900 transition-colors">{{ item.title }}</h3>
            <p class="mt-2 text-[13px] font-medium leading-relaxed text-[var(--text-primary)] italic">{{ item.description }}</p>
            <div class="mt-6 flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-[var(--text-primary)]">
          ...
          <div v-else class="space-y-10">
            <div v-for="(post, index) in rankedPosts" :key="post.id" class="space-y-6">
              <div class="flex flex-wrap items-center gap-3">
                ...
                <div class="inline-flex h-8 items-center gap-1.5 rounded-xl bg-white px-4 text-[10px] font-black uppercase tracking-widest text-[var(--text-primary)] ring-1 ring-secondary-100 shadow-sm">
