<template>
  <UCard
    class="overflow-hidden rounded-[30px] border border-[var(--border-default)] bg-[linear-gradient(135deg,#0f172a_0%,#0f766e_40%,#2563eb_100%)] text-white shadow-[var(--shadow-xl)]"
