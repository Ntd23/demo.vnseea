  ...
  const events: MockEvent[] = [
    {
      ...
      attendees: [
        ...
        { id: 2, name: "Bảo Trần", role: t("pages.eventsPage.attendeeProductManager"), initials: "BT", gradient: "linear-gradient(135deg,#0369a1,#f59e0b)", status: "going" },
        { id: 3, name: "Minh Anh", role: t("pages.eventsPage.attendeeDesigner"), initials: "MA", gradient: "linear-gradient(135deg,#2563eb,#0ea5e9)", status: "interested" },
    ...
    },
    {
      ...
      hostInitials: "HS",
      hostGradient: "linear-gradient(135deg,#0369a1 0%,#f59e0b 100%)",
      ...
      coverFallback: "linear-gradient(135deg,#0369a1 0%,#f59e0b 100%)",
      ...
      attendees: [
        { id: 5, name: "Quỳnh Lan", role: t("pages.eventsPage.attendeeFounder"), initials: "QL", gradient: "linear-gradient(135deg,#f59e0b,#0369a1)", status: "going" },
        ...
        { id: 7, name: "Linh Phạm", role: t("pages.eventsPage.attendeeMarketing"), initials: "LP", gradient: "linear-gradient(135deg,#0ea5e9,#2563eb)", status: "interested" },
      ],
    },
    {
    ...
    },
    {
      ...
      hostInitials: "LG",
      hostGradient: "linear-gradient(135deg,#2563eb 0%,#0ea5e9 100%)",
      ...
      coverFallback: "linear-gradient(135deg,#2563eb 0%,#0ea5e9 100%)",
      ...
      attendees: [
        { id: 11, name: "Ngọc Lê", role: t("pages.eventsPage.attendeeTrainer"), initials: "NL", gradient: "linear-gradient(135deg,#2563eb,#0ea5e9)", status: "going" },
        { id: 12, name: "Xu Nguyễn", role: t("pages.eventsPage.attendeeModerator"), initials: "XN", gradient: "linear-gradient(135deg,#0ea5e9,#f59e0b)", status: "going" },
        { id: 13, name: "Trang Đỗ", role: t("pages.eventsPage.attendeeTeacher"), initials: "TD", gradient: "linear-gradient(135deg,#0000ff,#0ea5e9)", status: "interested" },
      ],
    },
    {
      ...
      attendees: [
        { id: 14, name: "Thanh Hà", role: t("pages.eventsPage.attendeeVolunteer"), initials: "TH", gradient: "linear-gradient(135deg,#2563eb,#0ea5e9)", status: "going" },
        ...
        { id: 16, name: "Uyên Phạm", role: t("pages.eventsPage.attendeeOrganizer"), initials: "UP", gradient: "linear-gradient(135deg,#0000ff,#2563eb)", status: "going" },
      ],
    },
    {
      ...
      attendees: [
        ...
        { id: 19, name: "Hải Đăng", role: t("pages.eventsPage.attendeeOps"), initials: "HD", gradient: "linear-gradient(135deg,#0369a1,#111827)", status: "going" },
      ],
    },
  ]
