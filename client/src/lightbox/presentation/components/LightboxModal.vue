...
import { createLightboxInitials, normalizeLightboxIndex } from "../../domain/services/lightbox-navigation.service"
import type { LightboxItem } from "../../domain/types/lightbox.types"
...
const normalizedIndex = computed(() => {
  return normalizeLightboxIndex(props.currentIndex, props.items.length)
})
...
const authorInitials = computed(() => {
  return createLightboxInitials(resolvedAuthor.value)
})
