<template>
  <UCard
    class="overflow-hidden rounded-[30px] border border-[var(--border-default)] bg-[linear-gradient(135deg,var(--bg-brand-hover)_0%,#0369a1_38%,#0f172a_100%)] text-white shadow-[var(--shadow-xl)]"
