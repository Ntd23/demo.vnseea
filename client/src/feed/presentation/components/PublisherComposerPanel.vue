      ...
      <div v-if="open" class="fixed inset-0 z-50 flex items-end justify-center sm:items-center" @click.self="emit('close')">
        ...
        <Transition enter-active-class="transition duration-200 ease-out" enter-from-class="opacity-0 translate-y-6 scale-[0.97]" enter-to-class="opacity-100 translate-y-0 scale-100">
          <section v-if="open" class="relative z-10 flex w-full max-w-2xl flex-col overflow-hidden rounded-t-[28px] bg-white shadow-[0_-8px_40px_rgba(15,23,42,0.10)] sm:max-h-[90vh] sm:rounded-[28px]">
            <div class="flex shrink-0 items-center justify-between border-b border-[var(--bg-brand)]/8 px-5 py-4">
              <div class="flex items-center gap-2.5">
                <div class="flex h-9 w-9 items-center justify-center rounded-full bg-[var(--bg-brand)]/8 text-[var(--text-brand)]">
            ...
            <div class="flex-1 space-y-5 overflow-y-auto p-5">
              ...
              <div>
                <p class="mb-3 text-[11px] font-semibold uppercase tracking-[0.08em] text-[var(--text-brand)]/50">{{ t("feed.publisherBox.audienceTitle") }}</p>
              ...
              <div>
                <p class="mb-3 text-[11px] font-semibold uppercase tracking-[0.08em] text-[var(--text-brand)]/50">{{ t("feed.publisherBox.advancedActionTitle") }}</p>
              ...
              <div>
                <p class="mb-3 text-[11px] font-semibold uppercase tracking-[0.08em] text-[var(--text-brand)]/50">{{ t("feed.publisherBox.advancedChipTitle") }}</p>
            ...
            <div class="flex shrink-0 flex-wrap items-center justify-end gap-2 border-t border-[var(--bg-brand)]/8 px-5 py-4">
