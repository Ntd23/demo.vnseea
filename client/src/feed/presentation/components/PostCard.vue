...
import { createFeedMediaItems } from "../../domain/services/feed-media.service"
import { createHashtagPath, formatHashtagLabel } from "../../domain/services/feed-format.service"
import type { FeedComment, FeedPost } from "../../domain/types/feed.types"
...
const mediaItems = computed(() => createFeedMediaItems(props.post))
