...
export const appRoutes = {
  ...
  editEvent: (id: string | number) => `/events/edit/${encodeSegment(id)}`,
...
export const apiRoutes = {
  ...
  auth: {
    ...
    resendAccountCode: "auth/resend-account-code",
  ...
  events: {
    ...
    update: (id: string | number) => `events/${encodeSegment(id)}`,
    ...
    inviteCandidates: (id: string | number) => `events/${encodeSegment(id)}/invite-candidates`,
    invite: (id: string | number) => `events/${encodeSegment(id)}/invite`,
  },
  blogs: {
    list: "blogs",
  ...
  messages: {
    ...
    conversationNotifications: "messages/conversation-notifications",
    conversationSearch: "messages/conversation-search",
    sharedContent: "messages/shared-content",
  ...
  forum: {
    ...
    thread: (id: string | number) => `forum/threads/${encodeSegment(id)}`,
    threadReplies: (id: string | number) => `forum/threads/${encodeSegment(id)}/replies`,
    myThreads: "forum/my-threads",
    members: "forum/members",
    search: "forum/search",
    myMessages: "forum/my-messages",
    reply: (id: string | number) => `forum/replies/${encodeSegment(id)}`,
  },
  ads: {
    list: "ads",
    options: "ads/options",
  ...
  settings: {
    ...
    pointsTransfer: "settings/points-transfer",
    pointsQr: "settings/points-qr",
