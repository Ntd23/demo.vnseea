...
import type { EventCategoryKey } from "../../domain/types/events.types"
import { useEventsCatalog } from "../../infrastructure/mocks/eventsCatalog"
...
const { eventCategories } = useEventsCatalog()
