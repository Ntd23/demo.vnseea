...
import {
  ...
  eventTabKeys,
  useEventsCatalog,
} from "../../infrastructure/mocks/eventsCatalog"
import {
...
import EventsHero from "../components/EventsHero.vue"
...
const { events, eventTabs, eventCategories, eventCities } = useEventsCatalog()
