...
const defaultMovies: MockMovie[] = [
  {
    ...
    accent: "linear-gradient(135deg,var(--bg-brand-hover) 0%,var(--color-primary-400) 100%)",
  ...
  },
  {
    ...
    backdrop: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=1600&q=80",
    accent: "linear-gradient(135deg,#0284c7 0%,var(--color-primary-400) 100%)",
...
const defaultCollections: MovieCollection[] = [
  {
    ...
    to: "/watch",
    accent: "linear-gradient(135deg,var(--bg-brand) 0%,var(--color-primary-400) 100%)",
  },
  {
