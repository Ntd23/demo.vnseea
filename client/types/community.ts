...
export const communityGroupMembers: Record<string, CommunityGroupMember[]> = {
  "cong-dong-xe-dien-viet": [
    { id: 1, name: "Hoàng Minh", initials: "HM", role: "community.mock.members.role.admin", meta: "community.mock.members.meta.electric_admin", online: true },
    { id: 2, name: "Lan Phương", initials: "LP", role: "community.mock.members.role.moderator", meta: "community.mock.members.meta.electric_charging", online: true },
    { id: 3, name: "Tuấn Vũ", initials: "TV", role: "community.mock.members.role.active_member", meta: "community.mock.members.meta.electric_posts" },
    { id: 4, name: "Anh Khoa", initials: "AK", role: "community.mock.members.role.reviewer", meta: "community.mock.members.meta.electric_reviewer", online: true },
    { id: 5, name: "Bích Ngân", initials: "BN", role: "community.mock.members.role.member", meta: "community.mock.members.meta.electric_joined" },
  ],
  "founder-circle-vietnam": [
    { id: 6, name: "Khánh Vũ", initials: "KV", role: "community.mock.members.role.host", meta: "community.mock.members.meta.founder_saas", online: true },
    { id: 7, name: "Thanh Hà", initials: "TH", role: "community.mock.members.role.moderator", meta: "community.mock.members.meta.founder_growth" },
    { id: 8, name: "Minh Anh", initials: "MA", role: "community.mock.members.role.member", meta: "community.mock.members.meta.founder_edu", online: true },
    { id: 9, name: "Phú Lê", initials: "PL", role: "community.mock.members.role.member", meta: "community.mock.members.meta.founder_builder" },
  ],
  "ai-product-builders": [
    { id: 10, name: "Bảo Trân", initials: "BT", role: "community.mock.members.role.host", meta: "community.mock.members.meta.ai_consultant", online: true },
    { id: 11, name: "Nam Phạm", initials: "NP", role: "community.mock.members.role.moderator", meta: "community.mock.members.meta.ai_automation" },
    { id: 12, name: "Linh Đào", initials: "LĐ", role: "community.mock.members.role.member", meta: "community.mock.members.meta.ai_designer", online: true },
    { id: 13, name: "Quỳnh Lê", initials: "QL", role: "community.mock.members.role.member", meta: "community.mock.members.meta.ai_prototyping" },
  ],
  "di-va-hoc": [
    { id: 14, name: "Thu Hà", initials: "TH", role: "community.mock.members.role.host", meta: "community.mock.members.meta.learning_workshop", online: true },
    { id: 15, name: "Ngọc Lễ", initials: "NL", role: "community.mock.members.role.mentor", meta: "community.mock.members.meta.learning_roadmap" },
    { id: 16, name: "Huyền Trang", initials: "HT", role: "community.mock.members.role.member", meta: "community.mock.members.meta.learning_skills", online: true },
    { id: 17, name: "Mai Anh", initials: "MA", role: "community.mock.members.role.member", meta: "community.mock.members.meta.learning_joined" },
  ],
  "weekend-escape-club": [
    { id: 18, name: "Xu Nguyễn", initials: "XN", role: "community.mock.members.role.host", meta: "community.mock.members.meta.weekend_planner", online: true },
    { id: 19, name: "An Nhiên", initials: "AN", role: "community.mock.members.role.active_member", meta: "community.mock.members.meta.weekend_reviewer" },
    { id: 20, name: "Gia Bảo", initials: "GB", role: "community.mock.members.role.member", meta: "community.mock.members.meta.weekend_tips", online: true },
    { id: 21, name: "Mỹ Hậu", initials: "MH", role: "community.mock.members.role.member", meta: "community.mock.members.meta.weekend_trekking" },
  ],
}
